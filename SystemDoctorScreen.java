...
public class SystemDoctorScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        HospitalComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Boston Medical Center", "Massachusetts General Hospital", "Tufts Medical Center", "Holtzman Medical Group", "Boston Children's Hospital" }));

        CommunityComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Allston", "Back Bay", "Bay Village", "Brighton", "Roxbury", "Charlestown" }));
                        ...
                        .addGroup(AddDoctorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(AddDoctorLayout.createSequentialGroup()
                                ...
                                .addGroup(AddDoctorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(HospitalComboBox, 0, 1, Short.MAX_VALUE)
                                    .addComponent(CommunityComboBox, 0, 165, Short.MAX_VALUE)
    ...
    private void ViewDoctorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewDoctorButtonActionPerformed
        ...
        for(int i=0 ; i<DoctorDirectory.arrayListLength();i++){
            Object[] rowData = new Object[]{
                doctorDirectory.get(i).id,
                doctorDirectory.get(i).name,
                doctorDirectory.get(i).email,
                doctorDirectory.get(i).gender,
                doctorDirectory.get(i).contact,
                doctorDirectory.get(i).hospital,
                doctorDirectory.get(i).community,    
            };
    ...
    private void AddNewDoctorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddNewDoctorButtonActionPerformed
        ...
        String doctorCommunity = CommunityComboBox.getSelectedItem().toString();
