...
public class HospitalAdminLogin extends javax.swing.JFrame {
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        String hpass = new String(adminPassword.getPassword());
        String hemail = adminEmail.getText();
        if (adminId.getText().isEmpty() || adminEmail.getText().isEmpty() || adminPassword.getPassword().length == 0) {
            ...
            for (HostipalAdmin hos : hospitalAdmin) {
                if (hos.email.equals(hemail) && hos.pass.equals(hpass)) {
                    loginUser = true;
                    break;
                } else {
                    loginUser = false;
