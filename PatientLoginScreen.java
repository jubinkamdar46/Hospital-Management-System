...
public class PatientLoginScreen extends javax.swing.JFrame {
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if (patientIdTextField.getText().isEmpty() || patientEmailTextField.getText().isEmpty() || patientPasswordTextField.getPassword().length == 0) {
        ...
        } else if (!patientIdTextField.getText().matches(id)) {
            ...
            for (Patients patient : PatientDirectory.arrayReturn()) {
                ...
                if(patientEmail.equals(patient.email) && patientPassword.equals(patient.password)){
                    patientFound = true;
                    System.out.println(patient.email +  ' ' + patient.password);
                    break;
                }else{
                    patientFound = false;
                }
