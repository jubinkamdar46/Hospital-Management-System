...
public class DoctorLoginScreen extends javax.swing.JFrame {
    ArrayList<Doctor> docdetail = new ArrayList<Doctor>();
    /**
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        if (docID.getText().isEmpty() | docEmail.getText().isEmpty() | docPass.getPassword().length==0){
            JOptionPane.showMessageDialog(this, "Please Fill all the fields" , "Warning", JOptionPane.ERROR_MESSAGE);
        }else if(!docID.getText().matches(idPattern)){
